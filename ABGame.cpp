...
vector<char> maxMinMidgamePhase(vector<char> board, int depth, int alpha, int beta);
vector<char> minMaxMidgamePhase(vector<char> board, int depth, int alpha, int beta);
...
vector<char> minMaxMidgamePhase(vector<char> board, int depth, int alpha, int beta){
    if(depth > 0){
        ...
        for(int i=0; i < bchildren.size(); i++){
            maxBoard = maxMinMidgamePhase(bchildren[i], depth, alpha, beta);
...
vector<char> maxMinMidgamePhase(vector<char> board, int depth, int alpha, int beta){
    if(depth > 0){
        ...
        for(int i=0; i < children.size(); i++){
            minBoard = minMaxMidgamePhase(children[i], depth, alpha, beta);
...
{   
    ...
    while(i){
        ...
        int alpha = -999999;
        int beta = 999999;
        vector<char> d = maxMinMidgamePhase(v, depth, alpha,beta);
