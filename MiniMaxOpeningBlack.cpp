...
vector<char> maxMinOpeningPhase(vector<char> board, int depth);
vector<char> minMaxOpeningPhase(vector<char> board, int depth);
...
vector<char> maxMinOpeningPhase(vector<char> board, int depth){
    if(depth > 0){
        ...
        for(int i=0; i < children.size(); i++){
            minBoard = minMaxOpeningPhase(children[i], depth);
...
vector<char> minMaxOpeningPhase(vector<char> board, int depth){
    if(depth > 0){
        ...
        for(int i=0; i < bchildren.size(); i++){
            maxBoard = maxMinOpeningPhase(bchildren[i], depth);
...
{   
    ...
    while(i){
        ...
        vector<char> d = maxMinOpeningPhase(b, depth);
